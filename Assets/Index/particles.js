...
class Particle {
    ...
    draw() {
        ctx.beginPath()
        //draw a circle and fill it at posX, posY ,of size, fromAngle 0rad ,to 2pi Rad 
    ...
    for(let i = 0; i < particlesArray.length; i++) {
        for(let j = i; j < particlesArray.length; j++) {
            ...
            if (distance < vicinityDist){
                ...
                ctx.strokeStyle = "rgba(123,12,64,"+ opacity +")"
                ctx.lineWidth = 1
                ctx.beginPath()
